  ...
  <div data-custom-class="body">
      ...
      >
        ...
        >
          ...
          >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <bdt className="block-component" />
                        <bdt className="block-component" />{" "}
                        <bdt className="question">Michigan</bdt>
                        <span
                          style={{
                            fontSize: "11.0pt",
                            lineHeight: "115%",
                    ...
                    <bdt className="block-component">
                      ...
                      >
                        ...
                        >
                          {" "}
                          at <bdt className="question">Lincoln Dr. </bdt>
                          <bdt className="block-component" />
                        </span>
                      </span>
                      , <bdt className="question">Huntington Woods</bdt>
                    </bdt>
                  </span>
                </span>
                    ...
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <span style={{ color: "rgb(89, 89, 89)" }}>
                          ...
                          <bdt className="block-component" />
                          <bdt className="block-component" />{" "}
                          <bdt className="question">48070</bdt>
                          <bdt className="statement-end-if-in-editor" />
                        </span>
                      </span>
                    </span>
            ...
            <bdt className="question">
              YOU NEED TO FILL THIS IN FOR EACH APPLICABLE COUNTRY.
            </bdt>
            <bdt className="statement-end-if-in-editor" />
          </span>
        </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <bdt className="question">
              <a
                href="https://www.pinkinference.com"
                target="_blank"
                data-custom-class="link"
              >
                https://www.pinkinference.com
              </a>
            </bdt>
          </span>{" "}
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">(US)+1 (947) 517-2535</bdt>, email
          at <bdt className="question">pinkinference@gmail.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
          <bdt className="question">
            205 S State St, Ann Arbor, MI 48104, USA
          </bdt>
          <bdt className="block-component" />,{" "}
          <bdt className="question">Ann Arbor</bdt>
          <bdt className="block-component" />
          <bdt className="block-component" />,{" "}
          <bdt className="question">MI</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />
          <bdt className="block-component" />{" "}
          <bdt className="question">48104</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">Pink Inference, Co. </bdt>,
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">pinkinference@gmail.com</bdt>. If we ever
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Websites or
        any <span style={{ fontSize: "14.6667px" }}>Third-Party </span>Content
      ...
      >
        ...
        <strong>
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            ...
            >
              <a
                href="https://www.pinkinference.com/privacy"
                target="_blank"
                data-custom-class="link"
              >
                https://www.pinkinference.com/privacy
              </a>
            </bdt>
          </span>
        </strong>
        ...
        >
          <bdt data-type="conditional-block">
            ...
            >
              ...
              <span style={{ fontSize: "14.6667px" }}>, </span>without regard to
    ...
    >
      ...
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="question">Washetnaw</bdt>,{" "}
        <bdt className="statement-end-if-in-editor" />
        <bdt className="block-component" />
        <bdt className="question">Michigan</bdt>
    ...
    >
      ...
      <bdt className="block-component" style={{ fontSize: 15 }} />{" "}
      <bdt className="question">Washtenaw</bdt>
    ...
    >
      <span style={{ fontSize: 15 }}>
        <span style={{ color: "rgb(89, 89, 89)" }}>
          <bdt className="question">
            <strong>Pink Inference, Co. </strong>
          </bdt>
          <strong>
            <bdt className="block-component" />
          </strong>
        ...
        <strong>
          <strong>
            ...
            >
              <strong>
                <bdt className="block-component" />
                Phone: <bdt className="question">(US)+1 (947) 517-2535</bdt>
                <bdt className="statement-end-if-in-editor" />
              </strong>
            </span>
          </strong>
    ...
    >
      <strong>
        ...
        >
          <strong>
            <bdt className="question">pinkinference@gmail.com</bdt>
          </strong>
        </span>
      </strong>
    </div>
